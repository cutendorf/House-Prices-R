...
## 1. Linear model
Since we are predicting a continous target, it makes sense to start with a linear regression. Eventhough we have many features now due to dummy encoding, linear regression gives a good starting point for the modeling. Thus we will use it as a baseline 
